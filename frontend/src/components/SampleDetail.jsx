    ...
    <Paper withBorder radius="md" p="md">
      <Group justify="space-between" align="flex-start" mb="sm">
        <div style={{ minWidth: 0 }}>
          ...
          <Group gap={6} mt={6}>
            {(sample.tags || []).map((t) => (
              <Badge key={t} size="sm" variant="light" color="apeiron">
                {t}
              </Badge>
            ))}
          </Group>
        ...
        <Group gap="xs">
          <Tooltip label="Download JSON report">
            <Button
              ...
              component="a"
              href={api.reportUrl(sampleId, 'json')}
              target="_blank"
              rel="noreferrer"
          ...
          <Tooltip label="Download PDF report">
            <Button
              ...
              component="a"
              href={api.reportUrl(sampleId, 'pdf')}
              target="_blank"
              rel="noreferrer"
      ...
      <Tabs defaultValue="overview" keepMounted={false}>
        <Tabs.List>
          <Tabs.Tab value="overview" leftSection={<IconList size={14} />}>
            Overview
          </Tabs.Tab>
